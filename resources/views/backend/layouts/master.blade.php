        ...
        <div class="sidebar">
            ...
            <div class="form-inline">
                <div class="input-group" data-widget="sidebar-search">
                    <input class="form-control form-control-sidebar" type="search" placeholder="kategori, yazı ekleme.."
                           aria-label="Search">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    @foreach(config('menu') as $value)
                        <li class="nav-item">
                            <a href="@if($value['href'] != '#') {{ route($value['href']) }} @else # @endif"
                               class="nav-link">
                            ...
                            @if($value['sub_menu'] != false)
                                <ul class="nav nav-treeview">
                                    @foreach($value['sub_menu'] as $sub_menu)
                                        <li class="nav-item">
                                            <a href="@if($sub_menu['href'] != '#') {{ route($sub_menu['href']) }} @else # @endif" class="nav-link">
